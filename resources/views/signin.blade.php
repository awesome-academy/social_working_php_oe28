...
<!-- Mirrored from gambolthemes.net/workwise-new/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Aug 2020 02:10:57 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="signin-pop">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="cmp-info">
                            <div class="cm-logo">
                                <img src="/bower_components/demo-bower/assets/images/cm-logo.png" alt="">
                            ...
                            <img src="{{ asset('/bower_components/demo-bower/assets/images/cm-main-img.png') }}" alt="">
                        </div><!--cmp-info end-->
                    </div>
                    <div class="col-lg-6">
                        <div class="login-sec">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 no-pdd">
                                            <div class="checky-sec">
                                                <div class="fgt-sec">
                                                    <input id="c1" class="form-check-input" type="checkbox"
...
{{--                                                <a href="#" title="">Forgot Password?</a>--}}
                                ...
                                <div class="dff-tab" id="tab-4">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 no-pdd">
                                                <button type="submit" value="submit">{{ trans('sigin.get_started') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div><!--dff-tab end-->
        ...
        <div class="footy-sec">
            <div class="container">
                ...
                <p><img src="{{ asset('/bower_components/demo-bower/assets/images/copy-icon.png') }}"
...
<!-- Mirrored from gambolthemes.net/workwise-new/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Aug 2020 02:11:00 GMT -->
</html>
